...
public class AddStudentWindowController {
    ...
    public AddStudentWindowController() throws NotBoundException, RemoteException {
        ...
        students = (Students) registry.lookup("Students");

        subjects = (Subjects) registry.lookup("Subjects");
    ...
    private void initialize() throws RemoteException {
        ...
        subjectsTable.setItems(FXCollections.observableList(subjects.getAllSubjects()));
